// Contributor: Use this component to migrate the 'legacy_source/pages/instagram_trending.html' page.
...
<div className="section__container">
  <div className="section__header">InstagramTrending Page</div>
